...
const SinglePost = () => {
  ...
  return (
    <div className="single-post font-[Montserrat] bg-[#f9f4f0] max-w-8xl mx-auto px-6 py-12">
      <Navbar />
      <div className="font-[Montserrat] max-w-md bg-[#F5DAAA] mt-10 mx-auto px-6 py-12">
        <h1 className='text-3xl font-bold text-[#1b5059] mb-4 text-center '>{post.title}</h1>
      <p className='text-gray-700 text-sm leading-6.5'>{post.content}</p>
      </div>
      <Why />
      <Footer />
    </div>
